...
import { Truck, Leaf, Recycle, AlertCircle, Plus, MapPin } from 'lucide-react';
import { useService, WASTE_PRICES } from '../../context/ServiceContext';

export function ResidentSchedule() {
  const { pickups, schedulePickup } = useService();
  ...
  const handleSchedule = (e: React.FormEvent) => {
    e.preventDefault();
    if (date && location) {
      schedulePickup(new Date(date), type as any, location);
