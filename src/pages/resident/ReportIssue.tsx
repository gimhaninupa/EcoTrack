        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <label className="flex flex-col items-center justify-center aspect-square rounded-md border-2 border-dashed border-neutral-200 hover:border-forest-500 hover:bg-forest-50 transition-colors cursor-pointer">
